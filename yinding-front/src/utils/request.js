...
switch (process.env.VUE_APP_TYPE) {
  case 'development':
      // baseUrl ='/api'
    baseUrl = 'http://192.168.72.160:9091/rest/'
    break
  case 'sit':
    baseUrl = 'http://incsit.huaxiafinance.com/control-center/'
    break
  case 'uat':
    baseUrl = 'http://incuat.huaxiafinance.com/control-center/ '
    break
  case 'production':
    baseUrl = 'http://inc.huaxiafinance.com/control-center/ '
    break
}

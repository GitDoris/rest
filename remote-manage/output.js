{
  mode: 'development',
  context: 'd:\\vueglobal\\huaxia-double-record-video-list',
  ...
  output: {
    path: 'd:\\vueglobal\\huaxia-double-record-video-list\\dist\\development',
  ...
  resolve: {
    alias: {
      '@': 'd:\\vueglobal\\huaxia-double-record-video-list\\src',
    ...
    modules: [
      'node_modules',
      'd:\\vueglobal\\huaxia-double-record-video-list\\node_modules',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: 'd:\\vueglobal\\huaxia-double-record-video-list\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '9c8fc4ee'
            }
          },
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'd:\\vueglobal\\huaxia-double-record-video-list\\public\\index.html'
      }
    ),
    /* config.plugin('pwa') */
    new HtmlPwaPlugin(
      {
        name: 'huaxia-double-record-video-list-v3'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'd:\\vueglobal\\huaxia-double-record-video-list\\public',
          to: 'd:\\vueglobal\\huaxia-double-record-video-list\\dist\\development',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]

...
switch (process.env.VUE_APP_TYPE) {
  case 'development':
    //baseUrl = 'http://192.168.11.243:7777/shuanglu/'
    baseUrl = 'http://192.168.72.103:31401/contract-support/RemoteAudit/'
    //baseUrl = 'http://ip:31401/contract-support/'
    break
  case 'sit':
    baseUrl = 'http://incsit.huaxiafinance.com/huaxia-recording/'
    break
  case 'uat':
    baseUrl = 'http://incuat.huaxiafinance.com/huaxia-recording/'
    break
  case 'production':
    baseUrl = 'https://inc.huaxiafinance.com/huaxia-recording/'
    break
}

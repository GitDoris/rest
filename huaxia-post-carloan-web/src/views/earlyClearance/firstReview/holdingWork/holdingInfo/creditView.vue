...
<script>
  ...
  export default {
    ...
    created: function () {
      this.dataList = JSON.parse(sessionStorage.eCFirstData);
    ...
    methods: {
      ...
      //提交按钮
        ...
        eEarlyclearanceOperation(confirmParam).then(response => {
          if (response.data.code === "00000") {
            ...
            let pushUrl = "/earlyClearance/firstReview/pendingWork";
      ...
      goList(){
        this.$router.push({name:'firstReview',query:{activeName:'second'}})
      }

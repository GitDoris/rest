      ...
      <div class="form-box">
        <el-form :model="totalDetailVo" :rules="rules" ref="form" label-width="100px">
          <el-form-item label="减免原因" prop="adjustReason">
            <el-select v-model="totalDetailVo.adjustReason" disabled placeholder="请选择减免原因" style="width:300px">
          ...
          <el-form-item label="详情描述" prop="adjustRemark">
            <el-input  type="textarea" v-model="totalDetailVo.adjustRemark" disabled></el-input>
          </el-form-item>
          <!-- <el-form-item>

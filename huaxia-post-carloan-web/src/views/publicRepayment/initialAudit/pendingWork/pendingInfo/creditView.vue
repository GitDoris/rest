  ...
  <div class="maxBox">
    <div class="box box-primary">
      ...
      <div class="box box-primary">
        <div class="box-body" style="padding: 0;">
          <ul class="normalTitlebold">
            ...
            <li>挂账金额：
              <span>{{UserList.balance | fmoney(2)}}元</span>
            </li>
          </ul>
      ...
      <div class="tabTopstyle" value="">
        ...
        <el-row>
          <el-col :span="8"><span class="left_item">实际还款日：</span>{{PublicList.inputDate}}<span
      ...
      <!-- //提前结清信息-->
      <div class="tabTopstyle" value="" v-show="PublicList.payType==12">
        <el-row class="itemTitle">
          <h2>提前结清信息</h2>
        </el-row>
        <el-row>
...
<script>
  ...
  import MatchWater from './list/matchWater.vue'
      ...
      //提交按钮
        ...
        submit(confirmParam).then(response => {
          if (response.data.code === "00000") {
            ...
            let pushUrl = "/publicRepayment/initialAudit/pendingWork";
 ...
 goList(){
        this.$router.push({name:'initialAudit',query:{activeName:'first'}})
      }

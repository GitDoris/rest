<template>
    <div>
        ...
        <holding-work v-if="activeName=='second'"></holding-work>
        <handled-work v-if="activeName=='third'"></handled-work>
    </div>
</template>
<script>
import PendingWork from "./pendingWork/pendingWorkIndex.vue";
import HandledWork from "./handledWork/handledWorkIndex.vue";
import HoldingWork from "./handingWork/handingWorkIndex.vue";

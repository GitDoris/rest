...
<template>
  <div>
    ...
    <di-dialog v-if="isShow" @hidden="hiddenShow" @tryChild="childFrom" ref="DiDialog"></di-dialog>
  </div>
</template>

<script>
  import HxTable from '@/components/huaxia/HxTable/queryTable1carAfter'
  import {toDoTasks,initialAuditSubmit,newTask} from '@/api/carLoadAfterApi'
    ...
    methods: {
      ...
      contractNoClick(data) {
       ...
       // sessionStorage.caseCheckList = JSON.stringify(tempArray);
        ...
        pushUrl = "/publicRepayment/publicEnter/pendingWork/pendingInfo";
      ...
      addNewData(){
        // document.getElementById("dialog").style.display="block";
      	 this.isShow=true;
        //  console.log(this.$refs.DiDialog.$children[0])
        //  this.$refs.DiDialog.$children[0].abc();
      },
      hiddenShow(){
        this.isShow = false;
      },
